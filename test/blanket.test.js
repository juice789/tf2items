import { blanketify } from '../blanket.js'

const sortBySku = arr => [...arr].sort((a, b) => a.sku < b.sku ? -1 : a.sku > b.sku ? 1 : 0)
...
describe('blanketify', () => {
    ...
    it('should return a single result', () => {
        ...
        expect(sortBySku(blanketify(skus)({ sku }))).toEqual(sortBySku([
            {
                sku: '518;1',
    ...
    it('blanket kit', () => {
        ...
        expect(sortBySku(blanketify(skus, ['target'])({ sku }))).toEqual(sortBySku([
            {
    ...
    it('keeps every prop from the original item', () => {
        const skus = ['210;11', '210;11;kt-3', '210;11;festive']
        const sku = '210;11;kt-3;festive'
        expect(sortBySku(blanketify(skus)({ sku, id: 5875 }))).toEqual(sortBySku([
            {
                sku: '210;11',
                originalSku: '210;11;kt-3;festive',
                id: 5875
